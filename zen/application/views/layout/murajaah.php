	...
	<div class="container-fluid">
		<div class="row">
						...
						<tbody>
							<?php foreach($data_desc as $d){ ?>
								<tr>
									...
									<td><a href="/murajaah/edit/<?= $d->id ?>" class="btn btn-warning btn-sm">edit</a></td>
									<td><a href="/murajaah/hapus/<?= $d->id ?>" class="btn btn-danger btn-sm">hapus</a></td>
								</tr>
							<?php } ?>
						</tbody>
					</table>
			...
			<div class="col-sm-2 theia">
				<div class="theiaStickySidebar">
					<form action="/murajaah/tambah_upload" method="post">
